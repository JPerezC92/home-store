...
path.join(process.cwd(), "src/database/infrastructure/prisma/query_engine-windows.dll.node")

/**
 * Model PaymentMethodDB
 * 
 */
export type PaymentMethodDB = Prisma.PaymentMethodDBModel
/**
 * Model IncomeDB
 * 
 */
export type IncomeDB = Prisma.IncomeDBModel
/**
 * Model ExpenseDB
 * 
 */
export type ExpenseDB = Prisma.ExpenseDBModel
