      ...
      <div className="min-h-screen bg-background">
        <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="text-center py-12 text-foreground">
            <div className="inline-block animate-spin rounded-full h-12 w-12 border-b-2 border-jpc-vibrant-cyan-400"></div>
      ...
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="bg-card border border-jpc-vibrant-cyan-500/20 rounded-xl p-6 shadow-xl hover:shadow-2xl hover:shadow-jpc-vibrant-cyan-500/10 transition-all duration-300 hover:border-jpc-vibrant-cyan-500/40 group">
            ...
            <div className="text-4xl font-bold text-jpc-vibrant-cyan-400 group-hover:scale-105 transition-transform duration-300">{tasks.length}</div>
          </div>
          <div className="bg-card border border-jpc-vibrant-emerald-500/20 rounded-xl p-6 shadow-xl hover:shadow-2xl hover:shadow-jpc-vibrant-emerald-500/10 transition-all duration-300 hover:border-jpc-vibrant-emerald-500/40 group">
            ...
            <div className="text-4xl font-bold text-jpc-vibrant-emerald-400 group-hover:scale-105 transition-transform duration-300">{completedCount}</div>
          </div>
          <div className="bg-card border border-jpc-vibrant-orange-500/20 rounded-xl p-6 shadow-xl hover:shadow-2xl hover:shadow-jpc-vibrant-orange-500/10 transition-all duration-300 hover:border-jpc-vibrant-orange-500/40 group">
            ...
            <div className="text-4xl font-bold text-jpc-vibrant-orange-400 group-hover:scale-105 transition-transform duration-300">{pendingCount}</div>
          </div>
          <div className="bg-card border border-jpc-vibrant-purple-500/20 rounded-xl p-6 shadow-xl hover:shadow-2xl hover:shadow-jpc-vibrant-purple-500/10 transition-all duration-300 hover:border-jpc-vibrant-purple-500/40 group">
            ...
            <div className="text-4xl font-bold text-jpc-vibrant-purple-400 group-hover:scale-105 transition-transform duration-300">{highPriorityCount}</div>
          </div>
        </div>

        {/* Create Task Form */}
        <form onSubmit={handleCreate} className="bg-card border border-jpc-vibrant-cyan-500/20 rounded-xl p-8 shadow-xl hover:shadow-2xl hover:shadow-jpc-vibrant-cyan-500/10 transition-all duration-300 mb-12">
          ...
          <button
            type="submit"
            className="bg-jpc-vibrant-cyan-500/20 text-cyan-100 border border-jpc-vibrant-cyan-500/40 hover:bg-jpc-vibrant-cyan-500/30 hover:shadow-lg hover:shadow-jpc-vibrant-cyan-500/20 px-6 py-3 rounded-lg font-medium transition-all duration-300"
          >
            Add Task
          </button>
        </form>
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="bg-jpc-vibrant-cyan-500/20 text-cyan-100 border border-jpc-vibrant-cyan-500/40 px-3 py-1 rounded-full text-sm font-medium">
              {tasks.length} {tasks.length === 1 ? 'task' : 'tasks'}
            </span>
          </div>

          {tasks.length === 0 ? (
            <div className="text-center py-16 bg-card border border-jpc-vibrant-cyan-500/20 rounded-xl shadow-xl">
            ...
            <div className="space-y-6">
              {tasks.map((task) => (
                <div
                  key={task.id}
                  className="bg-card border border-jpc-vibrant-cyan-500/20 rounded-xl p-6 shadow-xl hover:shadow-2xl hover:shadow-jpc-vibrant-cyan-500/10 hover:border-jpc-vibrant-cyan-500/40 transition-all duration-300 group"
                >
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <span className={`px-3 py-1 rounded-full text-xs font-medium border ${
                          task.priority === 'high'
                            ? 'bg-jpc-vibrant-purple-500/20 text-jpc-vibrant-purple-400 border-jpc-vibrant-purple-500/40'
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-border/60">
                        <div className="flex items-center gap-3">
                          ...
                          {task.completed ? (
                            <span className="bg-jpc-vibrant-emerald-500/20 text-jpc-vibrant-emerald-400 border border-jpc-vibrant-emerald-500/40 px-3 py-1 rounded-full text-xs font-medium">
                              Completed
                            </span>
                          ) : (
                            <span className="bg-jpc-vibrant-orange-500/20 text-jpc-vibrant-orange-400 border border-jpc-vibrant-orange-500/40 px-3 py-1 rounded-full text-xs font-medium">
                              Pending
                            </span>
                          )}
                        </div>
                        <button
                          ...
                          className="bg-red-500/20 text-red-100 border border-red-500/40 hover:bg-red-500/30 hover:shadow-lg hover:shadow-red-500/20 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300"
                        >
                          Delete
                        </button>
                      </div>
